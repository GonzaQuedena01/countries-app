  ...
  <section class="home w-[100%]">
    <div class="home__container w-[90%] mx-auto flex items-center mt-20 flex-col gap-10">
      ...
      <img src="https://cdn.pixabay.com/photo/2016/04/01/22/55/countries-1301799_1280.png" alt="world-map"
           class="w-full h-auto min-w-[100px] max-w-[400px]"/>

      <p class="home__text text-lg text-gray-500 text-center">This is a simple app that displays information about countries.</p>
    </div>
  </section>
